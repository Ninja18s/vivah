<%-- 
    Document   : profile
    Created on : 26 Dec, 2020, 9:24:06 PM
    Author     : tarun
--%>
                                                ...
                                                <div class="col-md-9 profiles-list-agileits">
                                                        <div class="single_w3_profile">
                                                                ...
                                                                <div class="w3layouts_details">
                                                                    <h4>Profile ID : <%=rs.getString("profileId")%></h4>
                                                                        
                                                                    <p>24yrs /  <%=rs.getString("height")%> cm. <%=rs.getString("gender")%>  , <%=rs.getString("religion")%> , <%=rs.getString("cast")%> , <%=rs.getString("motherTongue")%> <%=rs.getString("country")%> .</p>
                                                        ...
                                                        <div class="profile_w3layouts_details">
                                                                <div class="agileits_aboutme">
                                                                        ...
                                                                        <div class="form_but1">
                                                                                <label class="col-sm-3 control-label1">Mother Name : </label>
                                                                                <div class="col-sm-9 w3_details">
                                                                                        <%=rs.getString("motherName")%> and she is <%=rs.getString("motherOccupation")%>.
                                                                                </div>
                                                                                <div class="clearfix"> </div>
                                                                        </div>
                                                                        <div class="form_but1">
                                                                                <label class="col-sm-3 control-label1">Father Name : </label>
                                                                                <div class="col-sm-9 w3_details">
                                                                                        <%=rs.getString("fatherName")%> and he is <%=rs.getString("fatherOccupation")%>.
                                                                                </div>
                                                                                <div class="clearfix"> </div>
                                                                        </div>
                                                                        <div class="form_but1">
                                                                                <label class="col-sm-3 control-label1">Sister : </label>
                                                                                <div class="col-sm-9 w3_details">
                                                                                    <%=rs.getString("sister")%>
                                                                                </div>
                                                                                <div class="clearfix"> </div>
                                                                        ...
                                                                        <div class="form_but1">
                                                                                <label class="col-sm-3 control-label1">Brother : </label>
                                                                                <div class="col-sm-9 w3_details">
                                                                                        <%=rs.getString("brother")%>
                                                                                </div>
                                                                                <div class="clearfix"> </div>
                                                                        </div>
                                                                        <div class="form_but1">
                                                                        ...
                                                                        <div class="form_but1">
                                                                                ...
                                                                                <div class="col-sm-9 w3_details">
                                                                                        <%=rs.getString("houseNumber")%>, <%=rs.getString("colony")%>, <%=rs.getString("city")%>, <br><%=rs.getString("state")%><%=rs.getString("country")%>
                                                                                </div>
                                                                                <div class="clearfix"> </div>
                                                                        </div>
                                                                        <div class="form_but1">
                                                                        ...
                                                                        <div class="form_but1">
                                                                                <label class="col-sm-3 control-label1">College : </label>
                                                                                <div class="col-sm-9 w3_details">
