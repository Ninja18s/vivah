		...
		<form action="checkRegister.jsp" method="post">
				<div class="w3_modal_body_grid">
					<span>Profile For:</span>
                                        <select id="w3_country" onchange="change_country(this.value)" name="profileFor" class="frm-field required">
				...
				<div class="w3_modal_body_grid w3_modal_body_grid1">
					<span>Name:</span>
					<input type="text" style="text-transform: uppercase;" name="name" placeholder="name " required=""/>
				</div>
				<div class="w3_modal_body_grid">
					<span>Gender:</span>
					<div class="w3_gender">
						...
						<div class="colr">
							<label class="radio"><input type="radio" name="gender" vlaue="female"><i></i>Female</label>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="clearfix"> </div>
				...
				<div class="w3_modal_body_grid">
					<span>religion:</span>
					<select id="w3_country1" onchange="change_country(this.value)" name="religion" class="frm-field required"> 
				...
				<!-- country codes (ISO 3166) and Dial codes. -->
					<input id="phone" name="mobileNumber" type="tel">
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						<div class="login-w3ls">
							<form id="signin" action="checkLogin.jsp" method="post">
